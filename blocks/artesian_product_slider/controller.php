<?php
namespace Concrete\Package\ArtesianProductSlider\Block\ArtesianProductSlider;
...
{
    protected $btTable = 'btArtesianProductSlider';
    ...
    {
        return t("Add a Product Slider for Vivid Store");
    }
    ...
    public function view()
    {
        ...
        $this->requireAsset("javascript", "flexslider");
        $this->requireAsset("css", "flexslider");
